...
declare -A sample_datasets=( ["mao01"]="1234" )
...
for dataset in "${!sample_datasets[@]}"; do
    ...
    echo "######################################################"
    /home/pablo.viana/jobs/github/aesop-metagenomics/src/0-hpc_job_scripts/execute_aesop_pipeline.sh $1 $dataset $project_id
done
